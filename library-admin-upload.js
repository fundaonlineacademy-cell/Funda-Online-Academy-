...
const canonicalType=v=>({ebook:'E-book','e-book':'E-book',textbook:'Textbook','study_guide':'Study Guide','study guide':'Study Guide',handbook:'Handbook',template:'Template & Tool','template & tool':'Template & Tool',reference:'Reference','reference material':'Reference','practical guide':'Practical Guide','professional guide':'Professional Guide','training_manual':'Training Manual','training manual':'Training Manual','training_package':'Training Package','training package':'Training Package',legislation:'Legislation',regulation:'Regulation','standards & legislation':'Standards & Legislation','supplementary reading':'Supplementary Reading','module resource':'Module Resource','learning_path':'Learning Path','learning path':'Learning Path'}[String(v||'').toLowerCase()]||v||'E-book');
function standardizeTypeSelect(){const s=el('fType');if(!s)return;const keep=canonicalType(s.value);const vals=['E-book','Textbook','Study Guide','Handbook','Template & Tool','Practical Guide','Professional Guide','Training Manual','Training Package','Reference','Legislation','Regulation','Standards & Legislation','Supplementary Reading','Module Resource','Learning Path'];s.innerHTML=vals.map(v=>`<option value="${v}">${v}</option>`).join('');s.value=vals.includes(keep)?keep:'E-book'}
