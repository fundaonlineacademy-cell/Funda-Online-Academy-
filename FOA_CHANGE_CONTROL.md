...
- In the lower Daily Operations row, **This Week** displays a maximum of three actions plus **View all actions**; do not let action volume stretch that card and make the row visually uneven. Operational Activity, This Week and Calendar keep matching desktop heights, and the compact Calendar remains inside a full-width rounded visual panel comparable to the graph.
