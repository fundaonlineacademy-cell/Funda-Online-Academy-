...
- **Admin Command Center system lock — 23 September 2026:** the full current Admin navigation and shared shell are protected. Browser refresh must retain the current valid Admin section; a new Admin entry from the approved Login page must land on My Dashboard. Source Sans 3, section-specific refresh policies, role separation, auditability and central-loader ownership are part of the lock. Academic is included in the system protection, while the rejected Statement of Results template remains explicitly unapproved/on hold. Reopen only the exact Admin area named by the owner; a change in one Admin area is not permission to alter another or the shared shell.

- The final owner-approved **Admin Ambassador Programme** workspace is protected at the audited 21 September 2026 state, including Programme Oversight, application/activation controls, referral evidence, performance tracking, confirmed earnings/payout visibility, Monthly Ambassador Challenge controls, Admin-only correspondence templates/history, Realtime behaviour and aligned reporting. Do not change these controls or presentation unless Aziwe Futhe explicitly reopens Ambassador Programme. Work in Academic, Assessments & Content or another Admin area does **not** reopen it.
- The final owner-approved **Admin Enrolments & Courses** workspace is protected at the audited 21 September 2026 state, including reversible controlled enrolment decisions, Finance-verified replacement-proof recovery, Student/Course/Status filtering, repaired Legacy Student Verification, compact Course Catalogue, compact Course Governance & Audit, Realtime tracking and aligned reporting. Do not change these controls or presentation unless Aziwe Futhe explicitly reopens Enrolments & Courses. Work in Ambassador Programme or another Admin area does **not** reopen it.
- The final owner-approved **Admin Marketing & Admissions** workspace is protected at the audited 21 September 2026 state, including the cleaned Marketing Studio, explicit 24h/7d/30d traffic analytics, strategic Marketing signals, compact marketing-only Ambassador Marketing Channel, Realtime tab-scoped refresh and aligned Marketing report. Do not change these controls or presentation unless Aziwe Futhe explicitly reopens Marketing & Admissions. Work in Enrolments & Courses or another Admin area does **not** reopen it.
- The final owner-approved **Admin Employer & Industry Partnerships** workspace is protected at the audited 21 September 2026 state ending with finalisation commit `22b9190c9ddf413ec50fc6dbacb66b2795bf93c0`, including the approved correspondence workspace, Realtime employer ecosystem, partner governance, graduate-employment pipeline and Employer report. Do not change these controls or presentation unless Aziwe Futhe explicitly reopens Employer & Industry Partnerships. Work in Ambassador Programme or another Admin area does **not** reopen it.
- The final owner-approved **Admin Voice & Feedback** workspace is protected at the audited state represented by commits `4644a616b3dc9dc696d4f72bc396cb48a9c75c34`, `48d38239dd55eda956a3b66da568488a2cd9485b` and `c05e43226156d8e3d8d6be7ab3ec755afee50f70`, plus the final live database accountability/privacy controls applied on 21 September 2026. Do not change Voice routing, confidentiality, case ownership, review history, public-response visibility, internal-note privacy, Realtime behaviour, reporting or responsive treatment unless Aziwe Futhe explicitly reopens Voice & Feedback. Work in Employer & Industry Partnerships or another Admin area does **not** reopen it.
- The final owner-approved **Admin Communication Hub** is protected at the final audited/permission-corrected state recorded in `COMMUNICATION_HUB_FINALISATION_2026_09_20.sql` and commits `e69eae2b3ca87f0528ddea4497adc4e9883f1c0c` / `49fa1b85c09acb16a4c291d6874e1cb38fa9131f`. Do not change Communication targeting, channel definitions, scheduling, recipient/read tracking, Realtime behaviour, safe Student-directory permission boundary, email delivery, FAQ/contact management, reporting or responsive treatment unless Aziwe Futhe explicitly reopens Communication Hub. Work in Marketing & Admissions or another Admin area does **not** reopen Communication Hub.
- The final owner-approved **Admin Student Support & CRM** workspace is protected at checkpoint `ef8597df568680a6cb97d12a7d8e6b527e951c3d`, together with the live Support database definitions recorded in `STUDENT_SUPPORT_CRM_FINALISATION_2026_09_21.sql`. Do not change the governed ticket lifecycle, atomic reply/status/ownership actions, database audit trail, consultation modes/workflow, private-note boundary, Support Realtime sources, reporting or responsive behaviour unless Aziwe Futhe explicitly reopens Student Support & CRM. Work in Voice & Feedback or another Admin area does **not** reopen Student Support & CRM.
- The final owner-approved **Admin Finance & Accounting** workspace is protected at code checkpoint `04fd55eddeaba73bb738bde9e6257ae06843fe5a`, together with the approved canonical Finance database definitions separating contractual receivables from current catalogue valuation. Do not change Finance KPI meanings, approved-receivables rules, payment-proof review, reconciliation/Accountant Pack workflows, canonical report calculations, Realtime/non-destructive refresh behaviour, responsive presentation or retired-legacy fallback status unless Aziwe Futhe explicitly reopens Finance. Work in Communication Hub or another Admin area does **not** reopen Finance & Accounting.
- The final owner-approved **Admin Management & Governance** workspace is protected at functional checkpoint `2eda8150de1254c2641b78d55cf819617a82134a`. Its Executive Governance Centre, Objectives/Policies/Risks/Actions/Decisions lifecycle registers, CEO Executive Action Centre, completion-history workflow, Africa/Johannesburg due-date logic, live governance report connection, Realtime coordination, responsive behaviour and Academy Direction must not be changed unless Aziwe Futhe explicitly reopens the affected area. Stability is protected: action completion/add/edit/refresh must preserve the Executive Action Centre in place, coalesce duplicate live events and must not cause the workspace to jump or repeatedly redraw. Work in Finance & Accounting or another Admin area does **not** reopen Management & Governance.
...
### Admin/Staff
- Professional Graduate CV document styling is intentionally distinct from the Admin UI: keep the CV preview/PDF in Times New Roman/Times, PDF body at 11 pt with readable ~1.5 paragraph spacing, Professional Profile justified, navy section headings, and black body text. Keep the Admin CV builder controls in Source Sans 3.
- Admin top-level navigation must preserve the active section across browser refreshes and internal data refreshes. Keep the saved-section/hash restoration behavior; do not default every reload back to My Dashboard unless no valid saved Admin section exists.
- Official Workplace Exposure Letter document styling is intentionally distinct from the Admin UI: keep the letter itself in Times New Roman/Times with 12 pt black body text, strong black subject heading, clean paragraph alignment, and no handwritten CEO signature unless the owner explicitly re-approves one. Keep the compact closing with Aziwe Futhe, Founder & Chief Executive Officer, Funda Online Academy.
- Official Workplace Exposure Letter must remain a full-width learner-specific builder under the CV tool, using the approved transparent Academy logo and fixed institutional details, learner/course data from Academy records, editable host/date/contact fields, completion-safe wording, live preview and PDF export. Do not claim successful course completion unless the Academy result/certificate record supports it. Student Workplace Exposure requests may capture host organisation/contact/location for Admin auto-fill; do not broaden this change to unrelated locked Student Portal areas without explicit owner approval.
- Career & Workplace Support must display **Professional Graduate CV first at full width**, with **Official Workplace Exposure Letter directly underneath at full width**. Do not group these two tools side-by-side without explicit owner approval.
...
- Admin Student figures/selectors must use Student-only filtering and must not count/display CEO-deleted tombstone profiles. Keep the enhanced My Dashboard and the base/fallback Admin view aligned so the Student total does not temporarily jump when rendering changes.
- Daily Operations must not use a self-triggering DOM mutation/render loop. Internal card updates must not cause repeated repaint/reflow or visible jitter; data refresh stays tied to initial load, navigation/load events and the approved Admin refresh flow.
- In the lower Daily Operations row, **This Week** displays a maximum of two actions plus **View all actions**; do not let action volume stretch that card and make the row visually uneven. Operational Activity, This Week and Calendar keep matching compact desktop heights, and the Calendar remains inside a slightly inset rounded visual panel comparable to the graph. Do not leave the temporary loading-layout class on populated cards because it can centre/push live content incorrectly.
...
- Admin refreshes are **non-destructive**: never hide, clear or replace a healthy current workspace merely because a background refresh/query times out or fails. Keep the last successfully rendered data visible and retry on the next manual/approved refresh. Do not restore the blocking `adminAwaitingLiveData` gate or the full-screen Retry state on My Dashboard.
...
- The **Academy Details / legal footer is permanent across every Admin tab** and sits outside the replaceable tab workspace so navigation/refreshes do not remove it. It shows registered business, company registration, professional-development status, WhatsApp, CEO professional email **aziwe@fundaonlineacademy.co.za**, and Admin Command Center reference, followed by the approved copyright/legal links. Do not restore Delivery Model or Learning Location to the Admin footer without explicit owner approval. Partner logos or partner-company listings must not be invented or added until a real owner-approved partnership exists.
