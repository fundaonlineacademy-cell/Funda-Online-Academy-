...
- The **Academy Details / legal footer is permanent across every Admin tab** and sits outside the replaceable tab workspace so navigation/refreshes do not remove it. It shows registered business, company registration, professional-development status, online delivery model, WhatsApp, learning location and Admin Command Center reference, followed by the approved copyright/legal links. Partner logos or partner-company listings must not be invented or added until a real owner-approved partnership exists.
