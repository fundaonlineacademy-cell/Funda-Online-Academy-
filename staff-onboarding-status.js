...
if(!window.__fundaFinanceCompatLoader){window.__fundaFinanceCompatLoader=true;['staff-finance-workspace.js','staff-finance-mobile-scroll-fix.js'].forEach(file=>{const s=document.createElement('script');s.src=file+'?v='+Date.now();document.head.appendChild(s)})}
})();
