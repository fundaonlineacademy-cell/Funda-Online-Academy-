...
function install(){
  ...
  style.textContent=`
    ...
    .cpcompbox{background:#fff;border:1px solid #dfd7c4;border-radius:20px;padding:20px;box-shadow:0 12px 30px rgba(33,56,77,.07)}.cpcompScroll{overflow-x:auto;-webkit-overflow-scrolling:touch}.cptable{width:100%;border-collapse:collapse;min-width:760px;font-size:12px}.cptable th,.cptable td{padding:12px;border-bottom:1px solid #eee7d8;text-align:left;vertical-align:top}.cptable th{background:#21384d;color:#fff;font-weight:800}.cpcompnote{font-size:12px;line-height:1.7;color:#111827;margin-top:14px}.cpcompstrong{font-weight:800;color:#21384d}
    @media(max-width:700px){.cpgrid{grid-template-columns:1fr}.cpwide{grid-column:auto}.cpbox{padding:20px}.cpplatform .cpwide{grid-column:auto}.cpcompbox{padding:14px}.cptable{font-size:11px}}
  `;
