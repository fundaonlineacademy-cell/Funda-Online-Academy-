...
function add(){
 ...
 const host=document.getElementById("dashboardContent")||document.querySelector("main")||document.body;
 const card=document.createElement("section");card.id="fundaStudentHouseRules";card.className="bg-white rounded-3xl border border-[#dbe6f2] shadow-sm p-5 md:p-6 mb-6";
