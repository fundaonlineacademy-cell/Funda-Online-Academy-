...
if (/admin-v2\.html$/i.test(window.location.pathname)) {
  const files=['admin-ui-direct.js','admin-theme-navy-gold.js','admin-report-centre.js','admin-business-intelligence.js','admin-marketing-studio.js','admin-marketing-live-fixes.js','admin-governance-centre.js','admin-finance-control-centre.js','admin-communication-centre.js','admin-header-lock.js'];
