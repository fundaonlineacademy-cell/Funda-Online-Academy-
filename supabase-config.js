...
if (/(courses-public|course-view)\.html$/i.test(window.location.pathname)) {
  ...
  if (/course-view\.html$/i.test(window.location.pathname)) {
    ['retail-course-overview-premium.js','bookkeeping-premium-overview.js','office-administration-premium-overview.js','carpentry-premium-overview.js'].forEach(file=>{
