...
(async()=>{try{await load('retail-premium-overview-stage1.js?v=20260829a');await load('retail-premium-overview-stage2.js?v=20260829a')}catch(e){console.error('Retail premium overview failed to load',e)}})();
})();