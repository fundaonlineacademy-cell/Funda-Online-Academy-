...
// ENROLMENTS
// IMPORTANT:
// We use SELECT * so the code does NOT require a
// created_at column.
// ============================================================
...
async function deleteAssessment(
  ...
  if (
    !confirm(
      "Delete this assessment? Student submissions for this assessment may also be deleted depending on your database rules."
    )
  ) {
    return;
  }
