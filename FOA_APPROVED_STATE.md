...
- **Owner-approved desktop motivation expansion — 23 September 2026:** the general motivational message fills the available left-column space more completely while the four approved values stay bottom-aligned with the unchanged **Know what to expect before you enrol.** board. The learner-image hero, restored text-only mobile introduction and hidden mobile clarity section remain unchanged.
- **Owner-approved desktop readability lock — 23 September 2026:** from the course catalogue through the contact section and footer, small desktop text is increased for consistent readability with the approved introduction. This is a typography-size refinement only: mobile sizing, section layout, spacing, colours, content, course cards, filters, sorting, FAQs, routes, scripts and all other Browse Courses behaviour remain unchanged. This desktop readability state is protected and must not be altered without explicit owner approval.
...
- Internal disciplinary review/appeal does not replace or restrict any applicable statutory external dispute-referral right. An overturned internal review must clear the disciplinary sanction, and a varied review must record the revised finding/sanction as the authoritative case outcome.
...
### Admin HR & Team (HRM 2) — FINAL OWNER-APPROVED AND LOCKED (23 September 2026)
...
- **HRM 2 is fully locked as a change-controlled protected Admin surface.** No HR runtime, database, workflow, navigation, typography, pagination, compliance reference, Staff Portal handoff, compensation-planning, disciplinary-code or conduct-management change may be made unless Aziwe Futhe explicitly reopens the affected HR area.
- The protected HRM 2 scope includes: Team & Access; Staff Invitation History; Contracts & Documents; Leave & Attendance; Safety & Wellbeing; Training & Performance; Workforce & Compensation Planning; Compensation Guidance; Disciplinary & Conduct; FOA Staff Disciplinary Code; Staff policy issue/acknowledgement tracking; SA Labour Compliance; HR Audit Trail; Staff Portal handoff; and HR data-loading behaviour.
...
- All growing HRM 2 registers remain capped at **10 visible records per page**, with Previous / Next navigation where required.
...
- Work in Finance, Expenses & Income, Petty Cash, Academic, CEO Account Control, Digital Library, IT/Security or any other Admin area does **not** reopen HRM 2.
- A newly discovered HRM 2 defect, legal-reference update or requested enhancement is a protected change request and requires explicit owner approval before modification.
