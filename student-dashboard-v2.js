...
.sdOrientationSection{margin-top:18px;padding:25px;border:1px solid #dbe3ea;border-radius:23px;background:#fff;box-shadow:0 5px 16px rgba(20,49,77,.05)}.sdOrientationHead{max-width:930px}.sdOrientationHead h2{margin:6px 0 0;color:#17324a!important;font:900 23px/1.3 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdOrientationIntro{margin:9px 0 0;color:#293847;font-size:15px;line-height:1.7;font-weight:600}
.sdOrientationSteps{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px;margin-top:20px}.sdOrientationStep{padding:18px;border:1px solid #dbe3ea;border-radius:17px;background:linear-gradient(145deg,#fff,#f7faff)}.sdOrientationStepNo{width:34px;height:34px;display:grid;place-items:center;border-radius:10px;background:#071d49;color:#fff;font-size:14px;font-weight:900}.sdOrientationStep h3{margin:13px 0 0;color:#17324a!important;font:900 15px/1.35 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdOrientationStep p{margin:7px 0 0;color:#263746;font-size:13px;line-height:1.6;font-weight:600}
