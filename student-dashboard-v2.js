...
.sdBrand b{display:block;font-family:"Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif;font-size:18px;line-height:1.15;color:#17324a}
...
.sdAvatar{width:58px;height:58px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(135deg,#e8bd51,#f5dc8d);color:#17324a;font:800 20px "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}
.sdPerson b{display:block;font:800 15px "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdPerson small{display:block;color:#677585;font-size:10px;margin-top:3px}
...
.sdNav a,.sdNav button{width:100%;border:0;text-decoration:none;display:flex;align-items:center;gap:12px;padding:12px 12px;border-radius:12px;background:transparent;color:#17324a;font:800 12px "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif;cursor:pointer;text-align:left}
...
.sdCompactWelcome .sdWelcomeKicker{margin:0;color:#9a6c0d;font-size:12px;letter-spacing:.16em;font-weight:900;text-transform:uppercase}.sdCompactWelcome h1{margin:7px 0 0;color:#111827;font:900 30px/1.15 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdWelcomeMessage{max-width:900px;margin:10px 0 0;color:#293847;font-size:16px;line-height:1.7;font-weight:600}
...
.sdOrientationEyebrow,.sdOrientationKicker{margin:0;color:#e4c777;font-size:12px;letter-spacing:.16em;font-weight:900;text-transform:uppercase}.sdOrientationHero h1{max-width:900px;margin:8px 0 0;color:#fff!important;font:900 30px/1.22 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdOrientationHero>p:last-of-type{max-width:920px;margin:14px 0 0;color:#edf4ff;font-size:16px;line-height:1.72;font-weight:600}
...
.sdOrientationSection{margin-top:18px;padding:25px;border:1px solid #dbe3ea;border-radius:23px;background:#fff;box-shadow:0 5px 16px rgba(20,49,77,.05)}.sdOrientationHead{max-width:930px}.sdOrientationHead h2{margin:6px 0 0;color:#17324a!important;font:900 23px/1.3 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdOrientationIntro{margin:9px 0 0;color:#172b3f;font-size:15px;line-height:1.7;font-weight:700}
.sdOrientationSteps{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px;margin-top:20px}.sdOrientationStep{padding:18px;border:1px solid #dbe3ea;border-radius:17px;background:linear-gradient(145deg,#fff,#f7faff)}.sdOrientationStepNo{width:34px;height:34px;display:grid;place-items:center;border-radius:10px;background:#071d49;color:#fff;font-size:14px;font-weight:900}.sdOrientationStep h3{margin:13px 0 0;color:#06152f!important;font:900 15px/1.35 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdOrientationStep p{margin:7px 0 0;color:#172b3f;font-size:13px;line-height:1.6;font-weight:700}
.sdOrientationSplit{display:grid;grid-template-columns:minmax(0,1.22fr) minmax(280px,.78fr);gap:18px;margin-top:18px}.sdOrientationSplit>.sdOrientationSection{margin-top:0}.sdOrientationBenefits{display:grid;grid-template-columns:1fr 1fr;gap:11px;margin-top:18px}.sdOrientationBenefit{display:flex;gap:12px;padding:15px;border:1px solid #d9c27c;border-radius:15px;background:linear-gradient(145deg,#fff,#fffdf7)}.sdOrientationBenefitIcon{width:38px;height:38px;display:flex;align-items:center;justify-content:center;flex:0 0 auto;border-radius:10px;background:linear-gradient(145deg,#e8c45f,#d4aa42);color:#06152f;font:900 17px/1 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif;text-align:center;padding:0;box-shadow:0 3px 8px rgba(165,117,15,.20);border:1px solid #c6921f}.sdOrientationBenefit strong{display:block;color:#06152f;font-size:15px;font-weight:900}.sdOrientationBenefit span{display:block;margin-top:4px;color:#172b3f;font-size:13px;line-height:1.55;font-weight:700}
.sdOrientationChecklist{background:linear-gradient(145deg,#fffaf0,#fff);border-color:#e5ca84}.sdOrientationChecklist ul{margin:17px 0 0;padding:0;list-style:none}.sdOrientationChecklist li{position:relative;margin-top:11px;padding-left:25px;color:#172b3f;font-size:13px;line-height:1.55;font-weight:700}.sdOrientationChecklist li:before{content:"✓";position:absolute;left:0;top:0;color:#8a5f09;font-weight:900}
.sdOrientationGroups{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:13px;margin-top:20px}.sdOrientationGroup{padding:18px;border:1px solid #dbe3ea;border-radius:17px;background:#fbfdff}.sdOrientationGroup h3{margin:0;color:#8a5f09!important;font:900 13px/1.3 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif;letter-spacing:.08em}.sdOrientationGroup ul{margin:13px 0 0;padding:0;list-style:none}.sdOrientationGroup li+li{margin-top:10px;padding-top:10px;border-top:1px solid #e4eaf0}.sdOrientationGroup strong{display:block;color:#06152f;font-size:13px;font-weight:900}.sdOrientationGroup span{display:block;margin-top:3px;color:#172b3f;font-size:12px;line-height:1.5;font-weight:700}.sdOrientationGroupWide{grid-column:1/-1}
.sdOrientationAction{display:flex;align-items:center;justify-content:space-between;gap:22px;margin-top:18px;padding:23px 25px;border-radius:22px;background:#071d49;border:1px solid rgba(201,154,46,.58);color:#fff}.sdOrientationAction h2{margin:0;color:#fff!important;font:900 21px/1.3 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdOrientationAction p{max-width:680px;margin:7px 0 0;color:#edf4ff;font-size:14px;line-height:1.6}.sdOrientationButtons{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:9px}.sdOrientationButtons button{min-height:44px;padding:11px 14px;border-radius:11px;border:1px solid #e4c777;background:#e4c777;color:#17324a;font:900 12px "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif;cursor:pointer}.sdOrientationButtons button:nth-child(2){background:#fff;color:#17324a;border-color:#fff}.sdOrientationButtons button:nth-child(4){background:transparent;color:#fff;border-color:rgba(255,255,255,.65)}.sdOrientationButtons .sdNavigateAcademyButton{background:linear-gradient(135deg,#e8c45f,#d4aa42);color:#06152f;border-color:#e4c777}.sdOrientationButtons .sdNavigateAcademyButton[aria-expanded="true"]{box-shadow:0 0 0 2px rgba(228,199,119,.30),0 7px 18px rgba(2,17,36,.25)}
.sdSystemMap[hidden]{display:none!important}.sdSystemMap{margin-top:18px;padding:0;border:1px solid #d9c27c;border-radius:24px;background:#fffdf8;box-shadow:0 12px 32px rgba(7,29,73,.13);overflow:hidden}.sdSystemMapHeader{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;padding:22px 24px;background:linear-gradient(135deg,#fffdf7,#fff8e5);border-bottom:1px solid #ead7a0}.sdSystemMapTitle{display:flex;gap:14px;align-items:flex-start}.sdSystemMapIcon{width:44px;height:44px;display:grid;place-items:center;flex:0 0 auto;border-radius:12px;background:linear-gradient(145deg,#e8c45f,#d4aa42);color:#06152f;font-size:23px;font-weight:900;border:1px solid #c6921f}.sdSystemMapTitle h2{margin:5px 0 0;color:#06152f!important;font:900 23px/1.2 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdSystemMapTitle p:last-child{margin:8px 0 0;max-width:850px;color:#172b3f;font-size:14px;line-height:1.6;font-weight:700}.sdSystemMapClose{flex:0 0 auto;padding:10px 14px;border-radius:11px;border:1px solid #c6921f;background:#fff;color:#06152f;font:900 12px "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif;cursor:pointer}.sdSystemMapNotice{margin:16px 20px 0;padding:11px 14px;border:1px solid #e2c775;border-radius:12px;background:#fff8dc;color:#4f3b08;font-size:12px;line-height:1.55;font-weight:700}
.sdMapCanvas{position:relative;height:760px;margin:16px 20px 20px;border:1px solid #dfcf9f;border-radius:20px;overflow:hidden;background:radial-gradient(circle at 51% 48%,rgba(228,199,119,.26),transparent 23%),linear-gradient(180deg,#fffdf7,#f7f1e4)}.sdMapCanvas:before{content:"";position:absolute;inset:0;opacity:.36;background-image:repeating-radial-gradient(ellipse at 15% 18%,transparent 0 18px,rgba(183,145,46,.17) 19px 20px,transparent 21px 37px),repeating-radial-gradient(ellipse at 86% 78%,transparent 0 22px,rgba(7,29,73,.10) 23px 24px,transparent 25px 42px);background-size:430px 310px,520px 390px}.sdMapCanvas:after{content:"ONLINE SYSTEM MAP";position:absolute;right:22px;bottom:17px;color:#9a6c0d;font-size:10px;font-weight:900;letter-spacing:.18em}.sdMapContour{position:absolute;border:1px solid rgba(193,150,45,.22);border-radius:50%;transform:rotate(-9deg);pointer-events:none}.sdMapContourA{width:430px;height:205px;left:-90px;top:165px}.sdMapContourB{width:520px;height:245px;right:-120px;bottom:95px}.sdMapRoutes{position:absolute;inset:0;width:100%;height:100%;z-index:1}.sdMapRoutes path{fill:none;stroke:#ba8713;stroke-width:4;stroke-dasharray:9 9;stroke-linecap:round;opacity:.72}
.sdMapHub{position:absolute;z-index:4;left:50%;top:49%;transform:translate(-50%,-50%);width:260px;text-align:center}.sdMapHubScreen{padding:24px 18px 19px;border:4px solid #d4aa42;border-radius:16px;background:linear-gradient(145deg,#06152f,#0d3971);box-shadow:0 12px 30px rgba(6,21,47,.25);color:#fff}.sdMapHubScreen strong,.sdMapHubScreen span{display:block;letter-spacing:.13em}.sdMapHubScreen strong{font-size:24px}.sdMapHubScreen span{margin-top:2px;font-size:17px;font-weight:800}.sdMapHubScreen small{display:block;margin-top:10px;color:#edcf76;font-size:9px;font-weight:900;letter-spacing:.20em}.sdMapHubRibbon{margin:-1px auto 0;padding:8px 12px;width:92%;background:linear-gradient(90deg,#c58d0c,#f0d27e,#c58d0c);color:#06152f;font-size:9px;font-weight:900;letter-spacing:.10em;border-radius:0 0 9px 9px}
.sdMapNode{position:absolute;z-index:5;left:var(--x);top:var(--y);transform:translate(-50%,-50%);width:168px;min-height:103px;padding:31px 10px 10px;border:1px solid #dbc476;border-radius:14px;background:rgba(255,255,255,.97);box-shadow:0 7px 18px rgba(22,43,65,.14);text-align:center;color:#06152f}.sdMapBrowser{position:absolute;left:8px;right:8px;top:8px;height:17px;border-radius:6px 6px 3px 3px;background:#071d49}.sdMapBrowser:before{content:"•••";position:absolute;left:7px;top:-3px;color:#e4c777;font-size:10px;letter-spacing:1px}.sdMapNodeIcon{display:block;margin:0 auto 5px;color:#071d49;font-size:22px;font-weight:900;line-height:1}.sdMapNode strong{display:block;color:#06152f;font-size:13px;line-height:1.2;font-weight:900}.sdMapNode small{display:block;margin-top:4px;color:#263746;font-size:10px;line-height:1.3;font-weight:700}.sdMapHome{border-width:2px}
.sdMapCompass{position:absolute;z-index:3;left:28px;bottom:26px;width:92px;height:92px;border:2px solid #c6921f;border-radius:50%;background:rgba(255,253,247,.90);display:flex;align-items:center;justify-content:center;color:#06152f}.sdMapCompass b{font-size:38px;color:#b58216}.sdMapCompass span{position:absolute;top:5px;font-size:10px;font-weight:900}.sdMapCompass em{position:absolute;bottom:5px;font-style:normal;font-size:10px;font-weight:900}.sdMapCompass small{position:absolute;font-size:9px;font-weight:900;letter-spacing:18px;left:16px}
.sdMapLegend{position:absolute;z-index:5;right:20px;bottom:20px;width:205px;padding:12px 13px;border:1px solid #d9c27c;border-radius:13px;background:rgba(255,255,255,.94);box-shadow:0 6px 15px rgba(7,29,73,.10);color:#172b3f}.sdMapLegend strong{display:block;margin-bottom:7px;color:#06152f;font-size:11px;text-transform:uppercase;letter-spacing:.10em}.sdMapLegend span{display:flex;align-items:center;gap:7px;margin-top:6px;font-size:9px;font-weight:700}.sdMapLegendDot,.sdMapLegendHub{display:inline-block;width:9px;height:9px;border-radius:50%;background:#d4aa42}.sdMapLegendHub{background:#071d49;border:2px solid #d4aa42}.sdMapLegendLine{display:inline-block;width:18px;border-top:2px dashed #b58216}
...
.sdMotto{margin-top:22px;padding:16px 10px;border-radius:15px;background:linear-gradient(135deg,#fff9e8,#f5dda0);border:1px solid #ead39b;color:#b58216;text-align:center;font:800 12px "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.sdMotto small{display:block;margin-top:6px;color:#7c8793;font:800 7px "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif;letter-spacing:.24em}body.sdV2>header{background:#06152f!important}
...
function dashboardView(view){
 ...
 if(view!=='orientation'){
  const map=document.getElementById('academySystemMap');
  const mapToggle=document.querySelector('#studentOrientation [data-orientation-map-toggle]');
  if(map)map.hidden=true;
  if(mapToggle){mapToggle.setAttribute('aria-expanded','false');mapToggle.textContent='How to Navigate the Academy'}
 }
...
function install(){
 ...
 const map=document.getElementById('academySystemMap');
 const mapToggle=document.querySelector('#studentOrientation [data-orientation-map-toggle]');
 const mapClose=document.getElementById('academySystemMapClose');
 const setMapOpen=openMap=>{
   if(!map||!mapToggle)return;
   map.hidden=!openMap;
   mapToggle.setAttribute('aria-expanded',openMap?'true':'false');
   mapToggle.textContent=openMap?'Hide How to Navigate the Academy':'How to Navigate the Academy';
   if(openMap)setTimeout(()=>map.scrollIntoView({behavior:'smooth',block:'start'}),30);
 };
 mapToggle?.addEventListener('click',()=>setMapOpen(map?.hidden!==false));
 mapClose?.addEventListener('click',()=>{setMapOpen(false);mapToggle?.focus()});
