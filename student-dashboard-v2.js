...
.sdOrientationSplit{display:grid;grid-template-columns:minmax(0,1.22fr) minmax(280px,.78fr);gap:18px;margin-top:18px}.sdOrientationSplit>.sdOrientationSection{margin-top:0}.sdOrientationBenefits{display:grid;grid-template-columns:1fr 1fr;gap:11px;margin-top:18px}.sdOrientationBenefit{display:flex;gap:12px;padding:15px;border:1px solid #cfd9e3;border-radius:15px;background:#fff}.sdOrientationBenefitIcon{width:38px;height:38px;display:grid;place-items:center;flex:0 0 auto;border-radius:10px;background:#071d49;color:#fff;font-size:17px;font-weight:900;box-shadow:0 3px 8px rgba(7,29,73,.18)}.sdOrientationBenefit strong{display:block;color:#06152f;font-size:15px;font-weight:900}.sdOrientationBenefit span{display:block;margin-top:4px;color:#172b3f;font-size:13px;line-height:1.55;font-weight:700}
