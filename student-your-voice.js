...
.svKicker{margin:0;color:#e7c96f;font-size:12px;letter-spacing:.16em;font-weight:900;text-transform:uppercase}.svHero h1{max-width:820px;margin:8px 0 0;color:#fff!important;font:900 29px/1.25 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.svHero p:last-child{max-width:900px;margin:13px 0 0;color:#edf4ff;font-size:15px;line-height:1.7;font-weight:600}
.svPurposeGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:18px}.svPurpose{padding:17px;border:1px solid #dbe3ea;border-radius:16px;background:#fff}.svPurpose b{display:block;color:#17324a;font:900 14px "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.svPurpose span{display:block;margin-top:6px;color:#344658;font-size:13px;line-height:1.55;font-weight:600}.svPurpose i{display:grid;place-items:center;width:34px;height:34px;border-radius:10px;margin-bottom:11px;background:#fff2c7;color:#7f5707;font-style:normal;font-weight:900}
.svGrid{display:grid;grid-template-columns:minmax(0,1.12fr) minmax(320px,.88fr);gap:18px;margin-top:18px}.svPanel{padding:23px;border:1px solid #dbe3ea;border-radius:22px;background:#fff;box-shadow:0 5px 16px rgba(20,49,77,.05)}.svPanel h2{margin:5px 0 0;color:#17324a!important;font:900 22px/1.3 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif}.svIntro{margin:8px 0 0;color:#344658;font-size:14px;line-height:1.65;font-weight:600}
.svForm{display:grid;grid-template-columns:1fr 1fr;gap:13px;margin-top:19px}.svField{display:grid;gap:6px;color:#17324a;font-size:12px;font-weight:900}.svField.wide{grid-column:1/-1}.svField input,.svField select,.svField textarea{width:100%;border:1px solid #cdd9e5;border-radius:12px;background:#fff;color:#142b40;padding:12px 13px;font:600 14px/1.5 "Source Sans 3","Segoe UI",Roboto,Helvetica,Arial,sans-serif;outline:none}.svField textarea{min-height:145px;resize:vertical}.svField input:focus,.svField select:focus,.svField textarea:focus{border-color:#b88b22;box-shadow:0 0 0 3px rgba(201,154,46,.15)}
